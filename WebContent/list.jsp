...
<div>
			...
			pw.println("<tr><th class='whi'>S.No</th><th  class='whi'>ClassName</th><th  class='whi'>TeacherName</th><th  class='whi'>SubjectName</th><th  class='whi'>StudentName</th></tr>");
			for(Assign a:assign)
			{
				slno++;
				pw.println("<tr>");
				...
				pw.println("<td class='whi'>"+a.getTeacherID()+"</td>");
				pw.println("<td class='whi'>"+a.getSubject1ID()+"</td>");
